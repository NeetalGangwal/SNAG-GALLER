 ...
 */
public class pfquilling extends javax.swing.JFrame {

    /**
     * Creates new form pfquilling
     */
    public pfquilling() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photoframes/1.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 270, 250));

        l2.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l2.setText("Paper Quilling");
        getContentPane().add(l2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 170, -1, -1));
        ...
        l1.setText("Sn0117");
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, -1, -1));
        ...
        l3.setText("30x30x4cm");
        getContentPane().add(l3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 100, -1, -1));

        l4.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l4.setText("Rs 500");
        getContentPane().add(l4, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pfquilling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pfquilling().setVisible(true);
            }
        });
    }
