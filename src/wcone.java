 ...
 */
public class wcone extends javax.swing.JFrame {

    /**
     * Creates new form wcone
     */
    public wcone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/watch/3.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 210, 230));

        l1.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l1.setText("Sn0103");
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, 130, -1));

        l2.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l2.setText("Cone Art");
        getContentPane().add(l2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, 140, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, 180, 40));

        l3.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l3.setText("75x30x3cm");
        getContentPane().add(l3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 200, -1));

        l4.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        l4.setText("Rs 1000");
        getContentPane().add(l4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, 160, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wcone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
